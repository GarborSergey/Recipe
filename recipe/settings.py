...
SECRET_KEY = 'django-insecure-pw!j)wdt#=-67m%%oe*qkfslxs#vm+_xsv&e7g@j^*99@bpgr$'
...
STATIC_ROOT  =   os.path.join(PROJECT_ROOT, 'recipes/staticfiles')
STATIC_URL = '/static/'

# Extra lookup directories for collectstatic to find static files
STATICFILES_DIRS = (
    os.path.join(PROJECT_ROOT, 'recipes/static'), # ВОТ ТУТ СМОТРИ!
)
